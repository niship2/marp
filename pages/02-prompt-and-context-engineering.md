...
## 2-11. コンテキストエンジニアリングの重要性

---

## 2-12. コンテキストエンジニアリングとは
...
## 2-16. プロンプト形式の選択：マークアップ vs マークダウン
...
## 2-16. プロンプト形式の選択：マークアップ vs マークダウン（1）
...
## 2-16. プロンプト形式の選択：マークアップ vs マークダウン（2）
...
## 2-16. プロンプト形式の選択：マークアップ vs マークダウン（3）
...
## 2-16. プロンプト形式の選択：マークアップ vs マークダウン（4）
...
## 2-16. プロンプト形式の選択：マークアップ vs マークダウン（5）
...
特定の形式を強く推奨していないが、プロンプトエンジニアリングのベストプラクティスとして、指示とコンテキストを区切り文字（例：`###` や `"""`）で明確に分けることを推奨。マークダウンで記述されたプロンプトを非常にうまく解釈可能

**Google (Gemini シリーズ)**
推奨は特になし。プロンプト設計のベストプラクティスとして、「明確で具体的な指示を与えること」や「役割（ペルソナ）を与えること」などが挙げられており、これらの要素をマークダウンの見出しで整理するのは有効

---

## 2-16. プロンプト形式の選択：マークアップ vs マークダウン（6）
...
## 2-20. コンテキストエンジニアリングのベストプラクティス（1）
...
## 2-20. コンテキストエンジニアリングのベストプラクティス（2）
...
## 2-20. コンテキストエンジニアリングのベストプラクティス（3）
...
## 2-21. コンテキストエンジニアリング周辺の知識(3)　**Tool**
...
## 2-21. コンテキストエンジニアリング周辺の知識(4) **Model**
...
## 2-21. コンテキストエンジニアリング周辺の知識(5) **Context/Memory/Session**
...
## 2-22. プロンプトオーケストレーションマークアップ言語（POML）
...
## 2-22. プロンプトオーケストレーションマークアップ言語（POML）（続き）
...
## 2-22. プロンプトオーケストレーションマークアップ言語（POML）（2）
...
## 2-22. プロンプトオーケストレーションマークアップ言語（POML）（3）
...
## 2-22. プロンプトオーケストレーションマークアップ言語（POML）（4）
...
## 2-22. プロンプトオーケストレーションマークアップ言語（POML）（5）
...
## 2-22. プロンプトオーケストレーションマークアップ言語（POML）（6）
...
## 2-22. プロンプトオーケストレーションマークアップ言語（POML）（7）
...
## 2-22. プロンプトオーケストレーションマークアップ言語（POML）（8）
...
## 2-22. プロンプトオーケストレーションマークアップ言語（POML）（9）
...
## 2-23. AI エージェントの設計と実装における基盤技術要素
...
## 2-23. AI エージェントの設計と実装における基盤技術要素（1）
...
## 2-23. AI エージェントの設計と実装における基盤技術要素（2）
...
## 2-23. AI エージェントの設計と実装における基盤技術要素（3）
...
## 2-23. AI エージェントの設計と実装における基盤技術要素（4）
...
## 2-23. AI エージェントの設計と実装における基盤技術要素（5）
...
## 2-23. AI エージェントの設計と実装における基盤技術要素（6）
