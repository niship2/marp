...
## 2-1. なぜ AI は思ったような答えを返してくれないのか？（続き 2）
...
## 2-1. なぜ AI は思ったような答えを返してくれないのか？（続き 3）
...
## 2-1. なぜ AI は思ったような答えを返してくれないのか？（続き 4）
...
## 2-2. プロンプトエンジニアリングの基礎（続き 4）

#### プロンプト設計の基本原則（続き 2）

**4. Claude に考えさせる（思考の連鎖）**
...
## 2-3. 事例で学ぶ！プロンプトのブラッシュアップ体験 - 事例 1: 特許文献の要約（続き 2）
...
## 2-3. 事例で学ぶ！プロンプトのブラッシュアップ体験 - 事例 1: 特許文献の要約（続き 3）
...
## 2-3. 事例で学ぶ！プロンプトのブラッシュアップ体験 - 事例 1: 特許文献の要約（続き 4）
